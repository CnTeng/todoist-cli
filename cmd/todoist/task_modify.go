...
var taskModifyArgs = &sync.ItemUpdateArgs{}
...
var taskModifyCmd = &cli.Command{
	...
	Flags: []cli.Flag{
		...
		&cli.StringFlag{
			...
			OnlyOnce: true,
			Action: func(_ context.Context, _ *cli.Command, v string) error {
				taskModifyArgs.Due = &sync.Due{String: &v}
				return nil
			},
		},
		&cli.TimestampFlag{
			...
			Action: func(_ context.Context, _ *cli.Command, v time.Time) error {
				taskModifyArgs.Deadline = &sync.Deadline{Date: v, Lang: cfg.Lang}
				return nil
			},
		},
		&cli.IntFlag{
			...
			Action: func(_ context.Context, _ *cli.Command, v int64) error {
				taskModifyArgs.Priority = utils.IntPtr(int(v))
				return nil
			},
		},
		&cli.StringSliceFlag{
